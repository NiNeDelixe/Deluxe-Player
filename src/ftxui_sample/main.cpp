...
// configuration step. It creates a namespace called `Deluxe_Player`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Deluxe_Player::cmake::project_name, Deluxe_Player::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", Deluxe_Player::cmake::project_version);
      return EXIT_SUCCESS;
    }
