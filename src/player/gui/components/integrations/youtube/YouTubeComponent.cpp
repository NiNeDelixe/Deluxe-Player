#include "YouTubeComponent.hpp"

YouTubeComponent::YouTubeComponent()
{
    title.setText("Connect Youtube", juce::dontSendNotification);
...
void YouTubeComponent::paint(juce::Graphics& g)
{
